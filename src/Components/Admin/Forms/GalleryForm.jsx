...
const GalleryForm = ({ image, onSubmit, onCancel }) => {
  ...
  useEffect(() => {
    if (image) {
      ...
      const imageUrl = image.image 
        ? (image.image.startsWith('http') ? image.image : `${base_url}public/${image.image}`)
        : "";
  ...
  const validateForm = () => {
    ...
    if (!formData.imagePreview && !formData.existingImage && !image?.image)
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2d365b] focus:border-transparent transition-all duration-300"
            />
            {errors.title && (
                ...
                <label
                  ...
                  className={`flex items-center space-x-2 p-3 rounded-lg border cursor-pointer transition-all duration-200 ${
                    formData.category === category
                      ? "bg-[#2d365b] text-white border-[#2d365b]"
                      : "bg-gray-50 border-gray-300 hover:border-[#2d365b] hover:bg-gray-100"
                  }`}
                >
                  <input
                    type="radio"
          ...
          <div className="space-y-1">
            ...
            {hasImage && (
              <div className="relative">
                ...
                {/* Show info text for existing images */}
