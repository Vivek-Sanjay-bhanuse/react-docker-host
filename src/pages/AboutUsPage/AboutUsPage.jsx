// AboutUsPage.jsx – About hero styled like the reference
/* eslint-disable no-unused-vars */
import { motion } from "framer-motion";
import Navbar from "../../Components/User/Navbar/Navbar";
import VisionMission from "../../Components/User/VisionMission/VisionMission";
import FoundersTrustees from "../../Components/User/FoundersTrustees/FoundersTrustees";
import CoreTeamMembers from "../../Components/User/CoreTeamMembers/CoreTeamMembers";
import FoundationJourney from "../../Components/User/FoundationJourney/FoundationJourney";
import ImpactMetrics from "../../Components/User/ImpactMetrics/ImpactMetrics";
import DonateVolunteerCTA from "../../Components/User/DonateVolunteerCTA/DonateVolunteerCTA";
import Footer from "../../Components/User/Footer/Footer";

import AboutHeroBg from "../../assets/images/Homepage/aboutback.jpg";   // big background
import AboutHeroCard from "../../assets/images/Homepage/aboutcard.jpg"; // right card image
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-stretch gap-12 lg:gap-16 mt-[40px]">
            ...
            >
              ...
              <p className="mt-6 text-base md:text-lg lg:text-xl text-gray-200 font-medium max-w-xl leading-relaxed">
                We don&apos;t just help — we heal hearts, restore hope, and build a
                world where no one suffers in silence.
              </p>

              {/* 3 NUMBERED STEPS */}
              <div className="mt-12 flex flex-wrap gap-8 md:gap-10">
                {[
                  { num: "1", title: "Heal", subtitle: "Hearts" },
                  { num: "2", title: "Restore", subtitle: "Hope" },
                  { num: "3", title: "Build a", subtitle: "World" },
                ].map((step) => (
                  <div
                    key={step.num}
